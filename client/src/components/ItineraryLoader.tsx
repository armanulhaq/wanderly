...
const ItineraryLoader = () => {
    return (
        <div className="fixed inset-0 bg-subtle-purple backdrop-blur-sm flex flex-col items-center justify-center z-50">
            ...
            <p className="mt-6 text-lg font-medium text-purple-300 animate-fadeIn">
